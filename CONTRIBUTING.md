...
- `deps:global` - Устанавливает все зависимости в корне, включая общие зависимости для всех пакетов.

- `deps:packages` - Устанавливает зависимости внутри каждого пакета в монорепозитории.
