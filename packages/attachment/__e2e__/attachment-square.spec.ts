...
test.describe('AttachmentSquare', () => {
  test('Should render title/error', async ({ gotoStory, getByTestId }) => {
    await gotoStory({
      name: 'attachmentsquare',
      story: 'attachment-square',
      group: 'attachment',
      props: {
  ...
  test('Should not call onClick/onDownload callbacks in loading state', async ({ gotoStory, getByTestId }) => {
    ...
    await deleteAction.click().then(async () => await expect(deleteActionToast).toBeVisible());
    await attachment.click({ force: true }).then(async () => await expect(clickActionToast).not.toBeVisible());
  });
  ...
  test('Should call onDelete/onRetry callbacks in error state', async ({ gotoStory, getByTestId }) => {
    ...
    await deleteAction.click().then(async () => await expect(deleteActionToast).toBeVisible());
    await retryAction.click().then(async () => await expect(retryActionToast).toBeVisible());
  });
  ...
  test('Should not call onClick/onDelete/onDownload callbacks in disabled state', async ({
    ...
    await deleteAction.click({ force: true }).then(async () => await expect(deleteActionToast).not.toBeVisible());
    await downloadAction.click({ force: true }).then(async () => await expect(downloadActionToast).not.toBeVisible());
    await attachment.click({ force: true }).then(async () => await expect(clickActionToast).not.toBeVisible());
  });
