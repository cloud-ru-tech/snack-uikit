...
test.describe('Table', () => {
  ...
  test('Rows toolbar checkbox strategy with pinned rows', async ({ page, gotoStory }) => {
    await gotoStory({
      name: 'table',
      props: {
        'data-test-id': STORY_TEST_IDS.table,
        toolbarCheckBoxMode: 'pageRows',
        pinSomeRows: true,
      },
    });
    ...
    const selectedState = await selectors.getSelectedState(page).textContent();
    expect(selectedState).toEqual('{"1":true,"3":true,"4":true,"5":true,"6":true,"7":true,"8":true,"9":true}');
  ...
  test('All rows toolbar checkbox strategy with pinned rows', async ({ page, gotoStory }) => {
    await gotoStory({
      name: 'table',
      props: {
        'data-test-id': STORY_TEST_IDS.table,
    ...
    const selectedState = await selectors.getSelectedState(page).textContent();
    expect(selectedState).toEqual(
      '{"1":true,"3":true,"4":true,"5":true,"6":true,"7":true,"8":true,"9":true,"10":true,"11":true,"12":true,"13":true,"14":true,"15":true,"16":true,"17":true,"18":true,"19":true,"20":true,"21":true,"22":true,"23":true,"24":true,"25":true,"26":true,"27":true,"28":true,"29":true,"30":true,"31":true,"32":true,"33":true,"34":true}',
    );
